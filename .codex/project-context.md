...
- `apps/api` 已创建，当前包含 NestJS 11、Prisma 7、`@nestjs/config`、PrismaService、认证与会话、JWT Guard、用户模块、账本模块、成员角色管理、Ledger Policy 层、账户、分类、流水 API、M2 账户余额流水联动，以及基础统计 API。
...
- M2 账户余额流水联动已完成；基础统计 API 已完成首版；下一阶段优先进入 AI 编排、后台真实 API 接入或后续脚手架。
