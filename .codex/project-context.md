...
- `apps/api` 已创建，当前包含 NestJS 11、Prisma 7、`@nestjs/config`、PrismaService、认证与会话、JWT Guard、用户模块、账本模块、成员角色管理、Ledger Policy 层，以及 M1.5 账户、分类、流水 API。
...
- M1.5 已合入并推送到 `main`；下一阶段优先进入 M2 的账户余额流水联动、基础统计或 AI 编排。
