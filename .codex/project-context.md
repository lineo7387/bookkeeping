...
- `apps/admin-web` 已创建，当前为 Vue 3、TypeScript、Vite、Tailwind CSS、`lucide-vue-next`，首页已通过 `@bookkeeping/api-client` 接入 M3 后台只读 Admin API；本地 Vite dev server 已配置 `/api` 代理到 `http://127.0.0.1:3000`。
